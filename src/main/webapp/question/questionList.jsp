...
<div class="data_list">
    ...
    <div class="search_content">
        ...
        <button style="float: right;margin-bottom: 8px;" class="btn btn-mini btn-primary" type="button"
                onclick="javascript:window.location='student!preSave'">添加考生题目
        </button>
    </div>
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-mini btn-info" type="button"
                                onclick="javascript:window.location='question!getQuestionById?questionId=${question.id}'">查看试题
                        </button>&nbsp;&nbsp;
                        <button class="btn btn-mini btn-info" type="button"
                                onclick="javascript:window.location='student!preSave?id=${student.id}'">修改
                        </button>&nbsp;&nbsp;
