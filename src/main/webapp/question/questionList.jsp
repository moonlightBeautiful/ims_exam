        ...
        <table class="table table-bordered table-hover">
            ...
            <c:forEach var="question" items="${questionList }" varStatus="status">
                <tr>
                    ...
                    <td>
                        <button class="btn btn-mini btn-info" type="button" onclick="javascript:window.location='question!getQuestionById?questionId=${question.id}'">查看试题</button>&nbsp;&nbsp;
                        <button class="btn btn-mini btn-info" type="button" onclick="javascript:window.location='question!preSave?questionId=${question.id}'">修改</button>&nbsp;&nbsp;
                        <button class="btn btn-mini btn-danger" type="button" onclick="questionDelete('${question.id}')">删除</button>
                    </td>
                </tr>
            </c:forEach>
        </table>
