        ...
        <form action="student!updatePassword" method="post" onsubmit="return checkForm()">
            <table width="40%" align="center">
                <tr>
                    ...
                    <td><input type="text" value="${currentUser.id }" name="student.id" readonly="readonly"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="password" id="newPassword" name="student.password"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2" style="align-content: center"><button class="btn btn-primary" type="submit">修改密码</button></td>
                </tr>
            </table>
        </form>
    </div>
